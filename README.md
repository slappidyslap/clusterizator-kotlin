...
- [ ] Добавить контекст о столбцах
- [ ] Возможность открыть файл экспортированный разных сервисов, то есть принимать csv файлы
- [ ] Диалог. окно на создания нового проекта, при импортирования csv файла
- [ ] Создать диалог. окно с произошедшему ошибками
- [ ] Таблицу сделать адаптивным
- [ ] В таблицу добавить другие столбцы (otherMetas) P.S. Скорее только частотность
- [ ] Возможность добавить новые ключевые слова
- [ ] Возможность изменять ключевые слова
